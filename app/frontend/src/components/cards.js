					...
					<CardContent>
						...
						>
							...
							<Box
								sx={{ alignItems: "center", textAlign: "center", width: "30%" }}
							>
								<Typography variant="body5">Position: {position}</Typography>
							</Box>
						</Box>
					</CardContent>
				</CardActionArea>
					...
					<CardContent>
						...
						>
							<Box sx={{ width: "70%" }}>
								...
								<Typography variant="body2">Game Week: {gameWeek}</Typography>
							</Box>
							{homeWinProb && awayWinProb && drawProb && (
								<Box sx={{ width: "20%", alignItems: "center" }}>
									...
									<Typography
										variant="body2"
										color={
											awayWinProb > drawProb && awayWinProb > homeWinProb
												? "green"
												: "white"
										}
									>
									...
									<Typography
										variant="body2"
										color={
											drawProb > awayWinProb && drawProb > homeWinProb
												? "green"
												: "white"
										}
									>
			...
			<Card key={teamId} sx={{ margin: 2 }} variant="outlined">
				...
				>
					<CardContent>
						...
						>
							<Box
								sx={{ alignItems: "center", textAlign: "center", width: "60%" }}
							>
				...
				>
					<Box sx={{ alignItems: "center", width: "100%" }}>
						...
						>
							...
							<Box
								sx={{ width: "35%", alignItems: "center", textAlign: "center" }}
							>
								<Typography variant="h5" component="div">
									<span> vs </span>
								</Typography>
						...
						{predictionOutput &&
							predictionResultColumns.map((column, index) => {
								return (
									<Box
										key={`data-${index}`}
...
export function ManagerCard(props) {
	...
	return (
		<Fragment>
			<Card key={managerId} sx={{ margin: 2}} variant="outlined">
				<CardContent>
					<Box
						sx={{
							display: "flex",
