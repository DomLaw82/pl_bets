...
export default function Players() {
    ...
    const fetchPlayerData = async (playerId) => {
        try {
            const statsResponse = await fetch(`${process.env.DATA_API_ROOT}/players/historic-stats/${playerId}`);
    ...
    useEffect(() => {
        const fetchPlayers = async () => {
            try {
                const response = await fetch(`${process.env.DATA_API_ROOT}/all-active-players`);
