...
export default function Players(props) {
	...
	const {
		...
		// error: playersError,
		data: players = [],
	} = useQuery("players", fetchPlayers, { staleTime: Infinity });
	...
	if (isLoadingPlayers) return <PageLoading />;
		...
		<QueryClientProvider client={queryClient}>
			<Fragment>
				<Container component="main">
					...
					>
						<Box
							sx={{ width: "100%", overflow: "hidden", overflowY: "scroll" }}
						>
							...
							<Box
								id="active-teams"
								sx={{ width: "100%", overflowY: "scroll", height: "61vh", alignItems: "center", alignContent: "center" }}
							>
								{searchTerm !== "" ? (
